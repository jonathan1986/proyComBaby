 ...
 */
// filepath: /home/jherrera/Documentos/Personal/GITHUB/proyComBaby/modules/GestionUsuarios/config.php

/**
 * Configuración del módulo GestionUsuarios
 */

// Configuración de Base de Datos
// Solo definir si no están ya definidas (por ejemplo, por bootstrap.php)
if (!defined('DB_HOST')) {
...
if (!defined('DB_USER')) {
    define('DB_USER', getenv('DB_USER') ?: 'jonathan');
}
if (!defined('DB_PASS')) {
